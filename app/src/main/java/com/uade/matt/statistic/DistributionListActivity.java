...
/**
 * An activity representing a list of Distributions. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link DistributionDetailActivity} representing
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(DistributionDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(DistributionDetailFragment.ARG_ITEM_ID, holder.mItem.id);
