...
public class MeanInferenceFragment extends DistributionFragment {
    ...
    private EditText etMean, etSize, etStandardDeviation, etSampleMean, etSampleSize,
            etSampleStandardDeviation, etLimitInf, etLimitSup, etError, etAlpha, etResult;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        etError.setFilters(new InputFilter[]{new MinMaxFilter(0, 99999999)});
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                .size((Double) getParsed(Helper.NumberType.DOUBLE, etSize))
                ...
                .sampleSize((Double) getParsed(Helper.NumberType.DOUBLE, etSampleSize))
