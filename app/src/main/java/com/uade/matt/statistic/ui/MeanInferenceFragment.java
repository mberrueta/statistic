...
public class MeanInferenceFragment extends DistributionFragment {
  ...
  private EditText /*etMean,*/ etSize, etStandardDeviation, etSampleMean, etSampleSize, etSampleStandardDeviation,
      etLimitInf, etLimitSup, etSampleError, etAlpha, etResult;
