...
public class ChiSquaredDistributionCalcTest {
  ...
  public void calculatePx() throws Exception {
    ChiSquaredDistributionCalc result = new ChiSquaredDistributionCalc().degreesOfFreedom(2.0).x(1.0).calculatePx();
  ...
  public void calculateInvPx() throws Exception {
    ChiSquaredDistributionCalc result = new ChiSquaredDistributionCalc().degreesOfFreedom(2.0).f(0.39347).calculatePx();
