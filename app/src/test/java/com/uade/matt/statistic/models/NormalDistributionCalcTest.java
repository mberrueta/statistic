...
public class NormalDistributionCalcTest {
  ...
  public void calculatePx() throws Exception {
    NormalDistributionCalc result = new NormalDistributionCalc().f(0.95).calculatePx();
  ...
  public void calculateInvPx() throws Exception {
    NormalDistributionCalc result = new NormalDistributionCalc().x(1.64485).calculatePx();
