...
public class PoissonDistributionCalcTest {
  ...
  public void calculatePx() throws Exception {
    PoissonDistributionCalc result = new PoissonDistributionCalc().frequency(245.0).r(280).calculatePx();
  ...
  public void calculateInvPx() throws Exception {
    PoissonDistributionCalc result = new PoissonDistributionCalc().frequency(245.0).g(0.01517).calculatePx();
    assertNotNull(result);
  ...
  public void calculateInvPxf() throws Exception {
    PoissonDistributionCalc result = new PoissonDistributionCalc().frequency(245.0).f(0.987017).calculatePx();
    assertNotNull(result);
    assertThat(result.resultMessage(), is("Range values: \nP(r<280) = 0.987017 \nP(r<281) = 0.988923"));
